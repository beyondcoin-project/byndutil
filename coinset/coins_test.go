...
import (
	...
	"github.com/beyondcoin-project/byndutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    byndutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() byndutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value byndutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = byndutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = byndutil.NewTxFromBytes(testSimpleCoinTxBytes)
