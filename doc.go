...
A Block defines a beyondcoin block that provides easier and more efficient
...
A Tx defines a beyondcoin transaction that provides more efficient manipulation of
...
To decode/encode an address:
	...
	addr, err := byndutil.DecodeAddress(addrString, defaultNet)
	if err != nil {
		fmt.Println(err)
		return
	}
