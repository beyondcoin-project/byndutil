...
//   https://github.com/beyondcoin/bips/blob/master/bip-0032.mediawiki
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := byndutil.Hash160(k.pubKeyBytes())[:4]
...
// Address converts the extended key to a standard beyondcoin pay-to-pubkey-hash
// address for the passed network.
func (k *ExtendedKey) Address(net *chaincfg.Params) (*byndutil.AddressPubKeyHash, error) {
	pkHash := byndutil.Hash160(k.pubKeyBytes())
	return byndutil.NewAddressPubKeyHash(pkHash, net)
}
