...
// Block defines a beyondcoin block that provides easier and more efficient
...
// Tx returns a wrapped transaction (byndutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (byndutil.Tx) for all
...
// instead provides easy access to wrapped versions (byndutil.Tx) of them.
...
// NewBlock returns a new instance of a beyondcoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a beyondcoin block given the
...
// NewBlockFromReader returns a new instance of a beyondcoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a beyondcoin block given
